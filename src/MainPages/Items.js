    ...
    return (
      <div className="bg-white">
        <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-1 text-base text-gray-500">Find your perfect fit for the classroom with RTU Apparel's wide selection of school uniforms items, available online now.</p>
