...
import { useAuth, UserAuth } from '../functions/authContext'
...
//         <img className='-mt-16 ml-5 w-32 h-32 rounded-full md:w-40 md:h-40' src={user?.photoURL || "https://pcgacademia.pl/wp-content/themes/pcgacademia-child/images/png/avatar-placeholder.png"} alt='' width="100" height="100"  />
