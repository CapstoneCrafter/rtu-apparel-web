...
//                 <h1 className='text-center text-3xl font-bold italic'>Forget Password</h1>
//                 </div>
...
//                 <div className='flex justify-center mb-3'>
//                     <button className='bg-indigo-600 mt-5 w-96 p-3 rounded-md text-white font-normal hover:opacity-90'>FORGET PASSWORD</button>
//                 </div>
