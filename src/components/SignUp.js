  ...
  return (
    ...
    <div className='max-w-7xl mx-auto mb-52'>
        ...
        <div className='mx-5 my-10 mb-20  md:flex items-center  '>
            ...
            <p className='text-gray-500 mt-4 text-center text-md italic md:text-sm md:text-justify md:mt-2 lg:text-2xl'>To receive updates on RTU apparel and exclusive promotions, 
