  ...
  return (
    <Fragment>
      ...
      <Accordion className="mb-4" open={open === 1}>
        <AccordionHeader className="text-lg font-bold text-left " onClick={() => handleOpen(1)}>
          What is RTU Apparel?
        </AccordionHeader>
        <AccordionBody className="text-md text-justify text-gray-500">
      ...
      <Accordion className="mb-4" open={open === 2}>
        <AccordionHeader  className="text-lg font-bold text-left" onClick={() => handleOpen(2)}>
      ...
      <Accordion className="mb-4" open={open === 3}>
        <AccordionHeader className="text-lg font-bold text-left"  onClick={() => handleOpen(3)}>
      ...
      <Accordion className="mb-4" open={open === 4}>
        <AccordionHeader className="text-lg font-bold text-left"  onClick={() => handleOpen(4)}>
      ...
      <Accordion className="mb-4" open={open === 5}>
        <AccordionHeader className="text-lg font-bold text-left"  onClick={() => handleOpen(5)}>
      ...
      <Accordion className="mb-4" open={open === 6}>
        <AccordionHeader  className="text-lg font-bold text-left" onClick={() => handleOpen(6)}>
      ...
      <Accordion className="mb-4" open={open === 7}>
        <AccordionHeader  className="text-lg font-bold text-left" onClick={() => handleOpen(7)}>
      ...
      <Accordion className="mb-4" open={open === 8}>
        <AccordionHeader  className="text-lg font-bold text-left" onClick={() => handleOpen(8)}>
      ...
      <Accordion className="mb-4" open={open === 9}>
        <AccordionHeader  className="text-lg font-bold text-left" onClick={() => handleOpen(9)}>
      ...
      <Accordion className="mb-4" open={open === 10}>
        <AccordionHeader className="text-lg font-bold text-left"  onClick={() => handleOpen(10)}>
